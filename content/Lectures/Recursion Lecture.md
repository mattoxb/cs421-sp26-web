...
questions for five minutes or so.
 ...
 - Did you know that if you take the first $n$ odd numbers and
   sum them, that the result is $n^2$? i.e., 
...
## Further Reading
 - [There and Back Again](http://www.brics.dk/RS/01/39/BRICS-RS-01-39.pdf)
    This is a research paper about a hybrid of forward recursion and tail recursion.
